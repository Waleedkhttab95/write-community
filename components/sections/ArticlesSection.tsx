...
<Article
    ...
    واستعرضت الورشة أبرز التحديات التي تواجه الفنانين عند كتابة نصوصهم، وقدمت أدوات عملية تساعدهم على صياغة محتوى فني متوازن.`}
          ...
          <Article
            title="لا سيف لمن لا قلم له"
            excerpt={`للقلم حدّةٌ قد تفوق حدّ المهند، وهيبةٌ أعظم من هيبة السيوف إذا سُلّت فلا قلم لمن لا فكر له، ولا فكر لمن لا كتابة له، ولا علم لمن لا يترجمه القلم؛ فالعلم يبدأ عند خطّه، ويزدهر به، وقد أشار القرآن إلى مكانته في قوله تعالى: ﴿الذي علّم بالقلم﴾.

إذا بقيت الفكرة حبيسة العقل تبقى غامضة مضطربة، وإذا صُوّرت بالقلم على الورق اتضح معناها وتميّز صوابها من خطئها، بالكتابة تتفتح أبواب الفهم، وتتسع المدارك، وقد يُبنى من فكرة صغيرة صرحٌ من المعرفة وعلمٌ ينتفع به الناس.

قديمًا كانت عظمة الشخص تقاس بشعره وبلاغته، وإذا كان له سيف يلوح به في معاركه ازدادت هيبته، أما اليوم، فلا تُستعمل السيوف إلا رموزًا للعروبة وقوتها الأولى، فالقوة الحقيقية الآن تكمن في فصاحة القلم.`}
            author="ساره نايف"
            date="2026-04-17"
            category="مقالات رأي"
            image="/images/no-sword-without-pen.jpg"
            slug="no-sword-without-pen"
          />

          <Article
            title="اكتب تاريخًا يتحدى النسيان!"
            excerpt={`وقفتُ على مقولة عجيبة تكشف عما أجده في نفسي من كل كتابٍ لا يذيله المؤلف أو يقدمه بتاريخ انتهائه منه، وأنقلها لكم من أدب الكُتّاب لأبي بكر الصولي "قيل: الكتاب بغير تاريخ نكرة بلا معرفة".
...
لا تهمل كتابة التاريخ، فكل تاريخٍ تكتبه يتحدى النسيان!`}
            author="البراء بن محمد"
            date="2026-04-27"
            category="مقالات ثقافية"
            image="https://images.unsplash.com/photo-1455390582262-044cdead277a?q=80&w=1673&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            slug="write-history-defying-forgetfulness"
          />

          <Article
            title="وهم الاستعداد للكتابة"
            excerpt={`اتسع حضور ورش الكتابة وبرامجها ومنصاتها بصورة لافتة في السنوات الأخيرة، وأتيح للكاتب عشرات الفرص ليتعلم تقنيات السرد، ويطوّر لغته، ويكتسب أدوات تساعده على بناء نصوص أكثر نضجًا.

في إحدى الاستشارات الكتابية مؤخرًا، أبلغتني الكاتبة أنها لسنوات لم تستطع إصدار كتابها الأول، رغم حضورها العديد من البرامج والورش عن الكتابة. حينها اتضح لي السبب وأبلغتها به: لقد قضيت الكثير من الوقت في الاستعداد للفعل بدل الفعل نفسه.

هذا ما يمكن تسميته وهم الاستعداد؛ أن يعيش الكاتب في حالة دائمة من التهيؤ، دون أن ينتقل إلى التنفيذ. وهو وهم مريح نفسيًا؛ لأنه يمنح شعورًا بالإنجاز دون مخاطرة حقيقية.

تنمو الكتابة على الطاولة، في عزلة النص، وفي التزام يومي لا يراه أحد. تمنح الدورات التدريبية الاتجاه، لكن النص لا يولد إلا بالانضباط.`}
            author="رائد العيد"
            date="2026-05-02"
            category="مقالات تعليمية"
            image="https://images.unsplash.com/photo-1501504905252-473c47e087f8?q=80&w=1674&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            slug="illusion-of-writing-preparation"
          />
