...
export default function ServicesTabsSection() {
  ...
  const individualServices = [
    {
      ...
      description: "تُقدَّم خدمة الاستشارات الكتابية لمساعدة الأفراد في تجاوز التحديات التي تواجههم أثناء تنفيذ مشاريعهم الكتابية، سواء كانت كتابًا أدبيًا أو مشروع كتابة وظيفية أو محتوى متخصص. تتيح هذه الخدمة للمستفيد طرح الأسئلة ومناقشة الإشكالات المرتبطة بالبنية، واللغة، والمنهجية، أو أسلوب السرد، ويُقدَّم له تحليل موضوعي ومهني لمشكلته مع مقترحات عملية للتطوير.",
      features: [
    ...
    },
    {
      ...
      description: "يُعد الإرشاد الكتابي مسارًا متقدمًا في دعم الكُتّاب، حيث يُخصَّص للكاتب مرافِق مهني يتابع تطوره خلال فترة زمنية محددة، من لحظة بلورة الفكرة وحتى اكتمال النص أو المشروع. بخلاف الاستشارة التي تتم لمرة واحدة، يقوم المرشد الكتابي بقراءة متتابعة للأعمال، وتقديم تغذية راجعة مرحلية.",
      features: [
    ...
    },
    {
      ...
      title: "كاتب الظل",
      description: "خدمة كاتب الظل (Ghostwriting) موجهة للأفراد الذين يملكون فكرة أو تجربة أو محتوى يرغبون بنقله إلى نص مكتوب متكامل، لكنهم لا يمتلكون الوقت أو المهارة الكافية لصياغته بأنفسهم. يقوم كاتب الظل بإجراء لقاءات مكثفة مع صاحب الفكرة لجمع المادة الخام.",
      features: [
  ...
  const entityServices = [
    ...
    },
    {
      ...
      title: "التصميم",
      description: "خدمة تصميم ورش العمل والدورات التدريبية موجّهة للجهات التي ترغب بتقديم محتوى تدريبي مخصص لجمهورها أو موظفيها، وتبحث عن بناء ورشة متكاملة من حيث الأهداف، والمنهجية، والمحتوى، والأنشطة التطبيقية. يعمل فريق مجتمع الكتابة على تصميم ورشة تعليمية فريدة تستجيب لاحتياجات الجهة.",
      features: [
    ...
    },
    {
      ...
      title: "البناء",
      description: "تُقدَّم خدمة تصميم البرامج الثقافية للجهات التي تسعى لتطوير مبادرات ثقافية مؤثرة تستند إلى رؤية واضحة، وهوية فكرية متماسكة، وتخطيط منهجي. يتولى فريق مجتمع الكتابة بناء برنامج ثقافي متكامل، يتضمن تصور الفكرة، صياغة الأهداف، تحديد المسارات التنفيذية، وصف المخرجات، وآليات القياس والتقييم.",
      features: [
