...
ومن الجدير بالذكر أن الورشة ضمن برنامج "كاتب المستقبل" بالشراكة مع مؤسسة الراجحي الإنسانية، وهو برنامج يسعى إلى تأهيل الكتاب بمهارات الكتابة المطلوبة في سوق العمل.
  ...
  'tech-writing': {
    ...
    content: ` 
    أصبحت العروض الفنية اليوم أحد المفاصل الحاسمة في سوق العمل، فهي الواجهة التي تُعرِّف بالمشاريع قبل تنفيذها، وتُقاس بها كفاءة الجهات وقدرتها على الفهم والتخطيط والتسليم. لم تعد جودة الفكرة وحدها كافية، بل صار نجاحها مرهونًا بقدرة صاحبها على تقديمها ضمن عرض فني واضح، منظم، ومقنع، يترجم الرؤية إلى خطوات قابلة للتنفيذ.
...
`,
  ...
  'no-sword-without-pen': {
    title: 'لا سيف لمن لا قلم له',
    content: `للقلم حدّةٌ قد تفوق حدّ المهند، وهيبةٌ أعظم من هيبة السيوف إذا سُلّت فلا قلم لمن لا فكر له، ولا فكر لمن لا كتابة له، ولا علم لمن لا يترجمه القلم؛ فالعلم يبدأ عند خطّه، ويزدهر به، وقد أشار القرآن إلى مكانته في قوله تعالى: ﴿الذي علّم بالقلم﴾.
...
إذا خطّ القلم، تعرفنا على أعماق عقولنا، وعلمنا أن الفكر الإنساني قادر على أن يولّد نورًا ومعرفةً لا تنطفئ، ويبقى صدى الكلمات حيًّا في عقول من يقرأها، يضيء لهم الطريق ويشعل نار الفضول، حتى تصبح الكتابة فعل حياة حقيقية، لا مجرد حبر على الورق.`,
  ...
  'write-history-defying-forgetfulness': {
    title: 'اكتب تاريخًا يتحدى النسيان!',
    content: `وقفتُ على مقولة عجيبة تكشف عما أجده في نفسي من كل كتابٍ لا يذيله المؤلف أو يقدمه بتاريخ انتهائه منه، وأنقلها لكم من أدب الكُتّاب لأبي بكر الصولي "قيل: الكتاب بغير تاريخ نكرة بلا معرفة".
...
الثلاثاء 10 ذي القعدة -وفقًا للرؤية الشرعية- 1447.
`,
